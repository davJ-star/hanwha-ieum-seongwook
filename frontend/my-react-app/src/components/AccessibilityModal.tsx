          ...
          <div className="guideline-container">
            ...
            <section className="guideline-section">
              <div className="guideline-subsection">
                ...
                <ol>
                  <li>
                    <b>MediLink 자체 개발 접근성 기능은 현재 tts, 수어 해설, 점자파일(.tsx) 변환 및 역변환이 제공되고 있습니다!</b>
                    <ul>
                      ...
                      <li>점자파일(.tsx) 변환 및 역변환 기능은 현재 한국어, 영어가 제공됩니다.</li>
                    </ul>
                  </li>
                  ...
                  <li>
                    <b>점자파일(.tsx) 변환 및 역변환 기능 활용 방법</b>
                    <ul>
                      <li>좌측의 점자파일 모양 아이콘을 클릭하면 해당 정보에 대한 안내가 점자파일(.tsx)로 제공되며 점자 역변환 버튼을 클릭하면 파일 창이 뜨고, 변환할 tsx 파일을 추가하면 텍스트로 역변환 되는 기능이 제공됩니다.</li>
                    </ul>
                  </li>
                </ol>
              </div>
