      ...
      <div className="community-page">
        <div className="community-content">
          <div className="board-list" role="navigation" aria-label="게시판 메뉴">
            ...
            <button onClick={() => navigate('/VIcommu')} aria-label="시각장애 게시판으로 이동" aria-current="page">시각장애 게시판</button>
          ...
          <div className="post-list-container" role="main">
